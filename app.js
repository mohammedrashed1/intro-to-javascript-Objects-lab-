...
if (starterIndex !== -1) {
    const currentStarter = game.party[starterIndex];
    let evolvedPokemonNumber;
    
    if (currentStarter.Number === 1) {
        evolvedPokemonNumber = 2;
    } else if (currentStarter.Number === 4) {
        evolvedPokemonNumber = 5;
    } else if (currentStarter.Number === 7) {
        evolvedPokemonNumber = 8;
    } else if (currentStarter.Number === 25) {
        evolvedPokemonNumber = 26;
    }
    
    if (evolvedPokemonNumber) {
        const evolvedPokemon = pokemon.find(p => p.Number === evolvedPokemonNumber);
